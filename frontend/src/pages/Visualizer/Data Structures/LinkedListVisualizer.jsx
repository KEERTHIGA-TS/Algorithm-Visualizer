...
// import { useVisualizationTracker } from '../../../hooks/useVisualizationTracker';
...
//     const initialStructureRef = useRef([]); // ✅ Track initial state
...
//         }
//     }, [isReplayMode]);  // ✅ Only depend on isReplayMode
...
//         hasReplayedRef.current = false; // ✅ reset once
...
//         setExplanation(`🔄 Replay loaded: ${history.algorithm.name}`);
...
//             }
//         },
//         [isRunning, resetUI, saveHistory, isReplayMode]
//     );
...
//                 "insertHead" // ✅ Pass operation name
//             );
...
//                 onConfirm={handleInsertHead} // ✅ Use handler
...
//                         isReplayMode={isReplayMode}   // ✅ REQUIRED
//                     />
